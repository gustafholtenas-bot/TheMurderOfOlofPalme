...
public:
    ...
    /** Creates persistent, selectable lane actors and saves them in the level. */
    UFUNCTION(CallInEditor, BlueprintCallable, Category="TMOP|Traffic|Editor")
    void BuildLaneNetworkInEditor();

    /** Removes only lane actors previously generated by this network actor. */
    UFUNCTION(CallInEditor, BlueprintCallable, Category="TMOP|Traffic|Editor")
    void ClearGeneratedLaneNetwork();

    UFUNCTION(CallInEditor, BlueprintCallable, Category="TMOP|Traffic|Editor")
    void RebuildLaneNetworkInEditor();
...
private:
    ...
    bool IndexPersistentLaneActors();
};
