...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="TMOP|Seat|Alignment", meta=(ClampMin="0.0"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="TMOP|Seat|Alignment", meta=(EditCondition="bUseManualApproachTransform"))
